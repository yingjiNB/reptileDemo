    ...
    var d = {}
        ...
        nc1x: function (a) {
            var c = this.i8a
                ...
                , k = this.blockSize
                , b = j / (4 * k)
                , b = a ? u.ceil(b) : u.max((b | 0) - this.Sz0x, 0);
            a = b * k;
            j = u.min(4 * a, j);
            if (a) {
                for (var q = 0; q < a; q += k)
...
(function (u) {
        ...
        r = r.MD5 = v.extend({
            mh1x: function () {
                this.cU9L = new w.init([1732584193, 4023233417, 2562383102, 271733878])
            },
            sH2x: function (q, n) {
                for (var a = 0; 16 > a; a++) {
                    var c = n + a
...
CryptoJS.lib.Cipher || function (u) {
    var p = CryptoJS
        ...
        createEncryptor: function (e, a) {
            return this.create(this.IV9M, e, a)
        },
        createDecryptor: function (e, a) {
            return this.create(this.brP6J, e, a)
        },
        init: function (e, a, b) {
...
(function () {
        ...
        var H = [0, 1, 2, 4, 8, 16, 32, 64, 128, 27, 54]
            , d = d.AES = p.extend({
            mh1x: function () {
                for (var a = this.J8B, c = a.words, d = a.sigBytes / 4, a = 4 * ((this.bbI2x = d + 6) + 1), e = this.bsr6l = [], j = 0; j < a; j++)
                    if (j < d)
                        e[j] = c[j];
                    else {
                        var k = e[j - 1];
            ...
            encryptBlock: function (a, b) {
                this.Es5x(a, b, this.bsr6l, t, r, w, v, l)
            },
            decryptBlock: function (a, c) {
                var d = a[c + 1];
                a[c + 1] = a[c + 3];
                a[c + 3] = d;
                this.Es5x(a, c, this.bsw6q, b, x, q, n, s);
                d = a[c + 1];
                a[c + 1] = a[c + 3];
                a[c + 3] = d
            },
            Es5x: function (a, b, c, d, e, j, l, f) {
                for (var m = this.bbI2x, g = a[b] ^ c[0], h = a[b + 1] ^ c[1], k = a[b + 2] ^ c[2], n = a[b + 3] ^ c[3], p = 4, r = 1; r < m; r++)
...
first = '{"id":"2076511018","c":"[{\\\\"id\\\\":\\\\"2076511018\\\\"}]","csrf_token":""}'
second = '010001';
...
fouth = '0CoJUm6Qyw8W8jud';

var ret = window.asrsea(first, second, third, fouth,)
console.log(ret)